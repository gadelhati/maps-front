...
//                                     <ButtonPage name={page + 2} function={() => handlePage(page + 1)} hidden={page >= page.totalPages - 1 ? true : false}/>
//                                     <ButtonPage name={'>'} function={() => handlePage(page + 1)} disabled={page >= page.totalPages - 2 ? true : false}/>
//                                     <ButtonPage name={'>>'} function={() => handlePage(page.totalPages - 1)}/>
//                                 </th>
//                             </tr>
//                             <tr><th>Total amount {page.totalElements}</th></tr>
//                         </tfoot>
//                     </table>
